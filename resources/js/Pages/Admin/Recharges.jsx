...
export default function Recharges({ active }) {
  return (
...
<th className="px-4 py-3 font-semibold tracking-[0.20em] text-[10px]">METHOD</th>
...
<td className="px-4 py-3 text-white/85">GCash</td>
